...
namespace Mindr.Domain.HttpRunner
{
    public static class MockedData
    {
        ...
        public static HttpItem GetHttpItem3()
        {
            return new HttpItem()
            {
                Name = "ProcessConnectorEventAsync3 Sample Text Message",
        ...
        public static IEnumerable<HttpItem> GetPipeline1()
        {
            return new List<HttpItem>() { GetHttpItem1(), GetHttpItem2() };
        }

        public static IEnumerable<HttpItem> GetPipeline2()
        {
            return new List<HttpItem>() { GetHttpItem3() };
        }
    }
}
